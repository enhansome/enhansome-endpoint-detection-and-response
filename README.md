...
* [Wazuh](https://github.com/wazuh/wazuh) ⭐ 16,551 | 🐛 2,979 | 🌐 C++ | 📅 2026-08-16 - The Open Source Security Platform - Wazuh helps you to gain deeper security visibility into your infrastructure by monitoring hosts at an operating system and application level. [Wazuh GIT](https://github.com/wazuh) : Lot of ressources for wazuh main software.
* [Zeek](https://github.com/zeek/zeek) ⭐ 7,883 | 🐛 247 | 🌐 C++ | 📅 2026-08-14 - Zeek is a powerful network analysis framework that is much different from the typical IDS you may know.
* [MISP](https://github.com/MISP/MISP) ⭐ 6,475 | 🐛 2,851 | 🌐 PHP | 📅 2026-08-13 - MISP (core software) - Open Source Threat Intelligence and Sharing Platform (formely known as Malware Information Sharing Platform)
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,181 | 🐛 67 | 🌐 Go | 📅 2026-08-16 : A tool for collecting host based state information using The Velociraptor Query Language (VQL) queries.
...
* [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,519 | 🐛 43 | 🌐 Go | 📅 2026-08-12 : A modern tool for Windows kernel exploration and tracing with a focus on security.
...
* [Rustinel](https://github.com/Karib0u/rustinel) ⭐ 453 | 🐛 45 | 🌐 Rust | 📅 2026-08-16 - Open-source endpoint detection engine for Windows and Linux using ETW, eBPF, Sigma, YARA, IOC matching, and ECS NDJSON alerts.
